    ...
    return function () {
        ...
        var Ut = function (e, t) {
                ...
                if (n.isStretchy) h = Pt(n, t), h = je.makeVList({
                    ...
                    var c, u;
                    "\\vec" === n.label ? (c = je.staticSvg("vec", t), u = je.svgData.vec[1]) : ((c = L(c = je.makeOrd({
                        mode: n.mode,
                        text: n.label
                    }, t, "textord"))).italic = 0, u = c.width), h = je.makeSpan(["accent-body"], [c]);
                    var p = "\\textcircled" === n.label;
                    p && (h.classes.push("accent-full"), m = i.height);
                    var d = o;
                    p || (d -= u / 2), h.style.left = d + "em", "\\textcircled" === n.label && (h.style.top = ".2em"), h = je.makeVList({
                        positionType: "firstBaseline",
                        children: [{
                            type: "elem",
                            elem: i
        ...
        })), fn("\\@ifstar", "\\@ifnextchar *{\\@firstoftwo{#1}}"), fn("\\TextOrMath", (function (e) {
        ...
        fn("\\char", (function (e) {
            ...
            if (t) {
                if (null == (a = gn[r.text]) || a >= t) throw new n("Invalid base-" + t + " digit " + r.text);
        ...
        }), fn("\\operatorname", "\\@ifstar\\operatornamewithlimits\\operatorname@"), at({
            type: "ordgroup",
            htmlBuilder: function (e, t) {
        ...
        var zn = function (e, t) {
            var r = e.base;
            return r ? "op" === r.type ? r.limits && (t.style.size === b.DISPLAY.size || r.alwaysHandleSupSub) ? hn : null : "operatorname" === r.type ? r.alwaysHandleSupSub && (t.style.size === b.DISPLAY.size || r.limits) ? wn : null : "accent" === r.type ? l.isCharacterBox(r.base) ? Ut : null : "horizBrace" === r.type && !e.sub === r.isOver ? nn : null : null
        };
        at({
            type: "supsub",
            htmlBuilder: function (e, t) {
        ...
        at({
            ...
            mathmlBuilder: function (e, t) {
                var r, n = zt(e.text, e.mode, t),
                    a = Tt(e, t) || "normal";
                return r = "text" === e.mode ? new Mt.MathNode("mtext", [n]) : /[0-9]/.test(e.text) ? new Mt.MathNode("mn", [n]) : "\\prime" === e.text ? new Mt.MathNode("mo", [n]) : new Mt.MathNode("mi", [n]), a !== An[r.type] && r.setAttribute("mathvariant", a), r
            }
        });
        var Tn = {
                "\\nobreak": "nobreak",
        ...
        at({
            type: "tag",
            mathmlBuilder: function (e, t) {
                var r = new Mt.MathNode("mtable", [new Mt.MathNode("mtr", [Nn(), new Mt.MathNode("mtd", [Nt(e.body, t)]), Nn(), new Mt.MathNode("mtd", [Nt(e.tag, t)])])]);
        ...
        var qn = {
            ...
            Rn = function (e, t) {
                var r = e.font;
                return r ? qn[r] ? t.withTextFontFamily(qn[r]) : Cn[r] ? t.withTextFontWeight(Cn[r]) : t.withTextFontShape(In[r]) : t
            };
        nt({
            type: "text",
        ...
        var On = function (e) {
            ...
            Pn = function () {
                ...
                return t.setCatcode = function (e, t) {
                    ...
                    if (null === r || r.index !== t) throw new n("Unexpected character: '" + e[t] + "'", new Ln(e[t], new Hn(this, t, t + 1)));
                    var a = r[6] || r[3] || (r[2] ? "\\ " : " ");
            ...
            Gn = function () {
                function e(e, t, r) {
                    this.settings = void 0, this.expansionCount = void 0, this.lexer = void 0, this.macros = void 0, this.stack = void 0, this.mode = void 0, this.settings = t, this.expansionCount = 0, this.feed(e), this.macros = new Fn(dn, t.macros), this.mode = r, this.stack = []
                }
                var t = e.prototype;
                return t.feed = function (e) {
                    ...
                    for (this.pushTokens(e); this.stack.length > r;) {
                        ...
                        n instanceof Ln && (n.treatAsRelax && (n.noexpand = !1, n.treatAsRelax = !1), t.push(this.stack.pop()))
                    }
                    return t
                    ...
                    if ("string" == typeof n) {
                        ...
                        for (var o = new Pn(n, this.settings), s = [], l = o.lex();
                    ...
                    return this.macros.has(e) || En.hasOwnProperty(e) || X.math.hasOwnProperty(e) || X.text.hasOwnProperty(e) || Vn.hasOwnProperty(e)
                }, t.isExpandable = function (e) {
                    var t = this.macros.get(e);
                    return null != t ? "string" == typeof t || "function" == typeof t || !t.unexpandable : En.hasOwnProperty(e) && !En[e].primitive
                }, e
            }(),
            Un = {
                "\u0301": {
